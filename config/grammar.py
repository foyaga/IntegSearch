...
def grammar(qtype):
    ...
    zone_query_syntax = [('title', '从信息系统中搜索网页标题包含 "如：标题1" 的数据'), ('group', '从信息系统中搜索集团公司包含 "xxxxx(empty表示该字段为空)" 的数据'),
                         ('company', '从信息系统中搜索所属公司包含 "xxxxx(empty表示该字段为空)" 的数据'),
                         ('html_banner', '从信息系统中搜索HTML原文包含 "如：零零信安" 的数据'),
                         ('ip', '从信息系统中搜索IP或IP段包含 "如：10.0.0.1、10.0.0.1/24、10.0.0.1-10.0.0.34" 的数据'),
                         ('url', '从信息系统中搜索URL包含 "如：https://0.zone" 的数据'),
                         ('is_ip_domain', '从信息系统中搜索URL类型包含 "如：IP组成/域名组成" 的数据'),
                         ('banner', '从信息系统中搜索端口返回信息包含 "如：零零信安" 的数据'), ('tags', '从信息系统中搜索标签包含 "如：登录页" 的数据'),
                         ('port', '从信息系统中搜索端口包含 "如：80" 的数据'), ('component', '从信息系统中搜索组件包含 "如：nginx" 的数据'),
                         ('service', '从信息系统中搜索服务包含 "如：http" 的数据'), ('os', '从信息系统中搜索操作系统包含 "如：Linux" 的数据'),
                         ('extra_info', '从信息系统中搜索设备分类包含 "如：负载均衡" 的数据'), ('app_name', '从信息系统中搜索APP名称包含 "如：零零信安" 的数据'),
                         ('status_code', '从信息系统中搜索状态码包含 "如：200" 的数据'), ('operator', '从信息系统中搜索运营商包含 "如：电信" 的数据'),
                         ('device_type', '从信息系统中搜索设备包含 "如：load balancer" 的数据'),
                         ('versions', '从信息系统中搜索版本包含 "如：1.0" 的数据'), ('cms', '从信息系统中搜索CMS包含 "如：WordPress" 的数据'),
                         ('cdn', '从信息系统中搜索CDN包含 "如：有" 的数据'), ('put_record', '从信息系统中搜索备案号包含 "如：ICP备xxx" 的数据'),
                         ('lang', '从信息系统中搜索开发语言包含 "如：java" 的数据'),
                         ('explore_timestamp', '从信息系统中搜索录入时间包含 "week代表查看最近7天" 的数据'),
                         ('country', '从信息系统中搜索国家包含 "如：美国" 的数据'), ('province', '从信息系统中搜索省包含 "如：北京" 的数据'),
                         ('city', '从信息系统中搜索市包含 "如：波特兰" 的数据'), ('ssl_info.detail', '从信息系统中搜索SSL证书详情包含 "如：零零信安" 的数据'),
                         ('ssl_info.issuer_cn', '从信息系统中搜索SSL证书颁发者公共名包含 "如：Amazon" 的数据'),
                         ('ssl_info.issuer_org', '从信息系统中搜索SSL证书颁发者机构名包含 "如：Amazon" 的数据'), ('ssl_info.subject_cn',
                                                                                           '从信息系统中搜索SSL证书公用名包含 "如：envoy-management.us-east-1.prod.lattice.aws.a2z.com" 的数据'),
                         ('ssl_info.subject_org', '从信息系统中搜索SSL证书机构名包含 "如：Valued DataDomain customer" 的数据')]
